// Run model-router's native subscription checks using model-router DB config
// stored in Weles service_credentials metadata.
//
// Required env: SUPABASE_URL and SUPABASE_SERVICE_ROLE_KEY for the Weles DB.
// Those are used only to read codex-reauth-config / claude-reauth-config.
