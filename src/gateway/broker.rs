...
const CENTRAL_REQUEST_SIGN_AGENTS: &[&str] = &["echo", "oko", "weles"];
...
/// verification. Echo, Oko, and Weles are strict central-item projections; they
/// never fall back to generated agent resources or another product.
